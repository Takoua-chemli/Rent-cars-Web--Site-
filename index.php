...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="center-text">
      <h2>Trouvez la meilleure voiture  <span>pour vous</span></h2>
      <p>Ici tu peux exactement trouver ce que tu cherche </p>
    </div>
    <div class="row"> 
...
<div class="col-list-3">
    <div class="recent-car-list">
        ...
        <div class="car-title-m">
            ...
            <span class="price"><?php echo htmlentities($result->PricePerDay);?> DT /Jour</span>
        </div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Notre Satisfait <span>Clientes</span></h2>
    </div>
    <div class="row">
